...
write.csv(setting_total, "featurized-decision-tree/python/experiments/expr/args/settings.csv")
...
setwd("featurized-decision-tree/python/experiments/expr/work")
...
#SBATCH -c 1
#SBATCH -N 1
#SBATCH -t 0-09:00			#job run 12 hour
#SBATCH -p shared
#SBATCH --mem=80G
#SBATCH -o %A_%a.out
#SBATCH -e %A_%a.err
...
conda deactivate"
  ...
  write(string, file = paste0("vs_exec", exec_id, ".sh"))
}
...
write.table(setting_total, "featurized-decision-tree/R/settings.txt", sep = ",", row.names = FALSE)
