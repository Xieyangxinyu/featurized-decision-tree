    ...
    for n in n_lst:
        for dim in dim_lst:
            for i in range(20):
                ...
                df_total.to_csv(
                    "/Users/wdeng/Desktop/data_cat/{data}_n{n}_d{d}_i{i}.csv".format(data=data, n=n, d=dim, i=i))
                psi.to_csv(
                    "/Users/wdeng/Desktop/data_cat/psi/{data}_n{n}_d{d}_i{i}.csv".format(data=data, n=n, d=dim, i=i))
    ...
    for n in n_lst:
        for dim in dim_lst:
            for i in range(20):
                ...
                psi = pd.DataFrame(psi)
                df_total.to_csv(
                    "/Users/wdeng/Desktop/data_cont/{data}_n{n}_d{d}_i{i}.csv".format(data=data, n=n, d=dim, i=i))
                psi.to_csv(
                    "/Users/wdeng/Desktop/data_cont/psi/{data}_n{n}_d{d}_i{i}.csv".format(data=data, n=n, d=dim, i=i))
    ...
    for n in n_lst:
        for dim in dim_lst:
            for i in range(20):
                ...
                df_total.to_csv(
                    "/Users/wdeng/Desktop/mi/{data}_n{n}_d{d}_i{i}.csv".format(
                        data=data, n=n, d=dim, i=i))
                psi.to_csv(
                    "/Users/wdeng/Desktop/mi/psi/{data}_n{n}_d{d}_i{i}.csv".format(
                        data=data, n=n, d=dim, i=i))
